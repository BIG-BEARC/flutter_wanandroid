...
homeEntityFromJson(HomeEntity data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = new List<HomeData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new HomeData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
homeDataFromJson(HomeData data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<HomeDatasTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new HomeDatasTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
homeDatasTagFromJson(HomeDatasTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> homeDatasTagToJson(HomeDatasTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
